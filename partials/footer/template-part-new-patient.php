<div class="container desktop-patient hidden-sm hidden-xs">
	<div class="col-sm-8">
		<header>
			<h1>New Patient Special</h1>
		</header>
		<div class="row">
			<div class="col-md-5">
				<h2>Includes:</h2>
				<ul>
					<li><i class="fa fa-check" aria-hidden="true"></i> X-Rays</li>
          <li><i class="fa fa-check" aria-hidden="true"></i> Cleaning</li>
          <li><i class="fa fa-check" aria-hidden="true"></i> Exam</li>
				</ul>
			</div>
			<div class="col-md-7">
...
<div class="container mobile-patient visible-sm visible-xs">
  <div class="row">
    <div class="col-sm-8">
      <header>
        <h1>New Patient Special</h1>
